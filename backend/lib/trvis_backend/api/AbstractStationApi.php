...
abstract class AbstractStationApi
{
     ...
     * POST createStation
     * Summary: 作成する
     * Notes: 指定のWorkGroupに属する Station (駅) を新しく作成する  属するWorkGroupへのWRITE権限が必要です。
     ...
     * Summary: 削除する
     * Notes: 既存のStationを削除する  このデータが属するWorkGroupへのWRITE権限が必要です。
     * Output-Formats: [application/json]
     *
     * @param ServerRequestInterface $request  Request
     * @param ResponseInterface      $response Response
     ...
     * GET getStation
     * Summary: 1件取得する
     * Notes: Station (駅) の情報を1件取得する  このデータが属するWorkGroupへのREAD権限が必要です。
     * Output-Formats: [application/json]
     *
     * @param ServerRequestInterface $request  Request
     * @param ResponseInterface      $response Response
     ...
     * GET getStationList
     * Summary: 複数件取得する
     * Notes: 指定のWorkGroupに属するStation (駅) の情報を複数件取得する  属するWorkGroupへのREAD権限が必要です。
     * Output-Formats: [application/json]
     *
     * @param ServerRequestInterface $request  Request
     * @param ResponseInterface      $response Response
     ...
     * PUT updateStation
     * Summary: 更新する
     * Notes: 既存のStationの情報を更新する  このデータが属するWorkGroupへのWRITE権限が必要です。
     * Output-Formats: [application/json]
     *
     * @param ServerRequestInterface $request  Request
     * @param ResponseInterface      $response Response
